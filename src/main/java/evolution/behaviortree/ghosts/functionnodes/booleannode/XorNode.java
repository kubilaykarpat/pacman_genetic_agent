...
public class XorNode extends FunctionNode {
	...
	@Override
	public XorNode copy(){
		return new XorNode(this.firstCond.copy(), this.secondCond.copy());
	}
	
	public XorNode(BehaviorNode firstCond, BehaviorNode secondCond){
